...
app.delete('/lists/:id', ListController.removeList);

app.post(
  '/lists',
  ListControllerValidations.addListValidation,
  ListController.addList,
);

app.patch(
  '/lists/:id',
  ListControllerValidations.updateListValidation,
  ListController.updateList,
);

app.post(
  '/lists/:listId/purchases',
  PurchaseControllerValidations.addPurchaseValidation,
  PurchaseController.addPurchase,
);

app.patch(
  '/lists/:listId/purchases/:purchaseId',
  PurchaseControllerValidations.updatePurchaseValidation,
